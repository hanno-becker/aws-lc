...
# We don't need the standalone header since we include all sources
# in ml_kem.c directly
rm $SRC/mlkem_native.h

# We use a default, so can remove the default one
rm $SRC/config.h
